 ...
 * Commented out Color Sensor and Movement from leftover TeleOpMode
 **/


@TeleOp(name="AutoOpMode", group="Linear Opmode")
//@Disabled
    ...
    public void runOpMode() {
        ...
        */
        ...
        while (opModeIsActive()) {
            ...
            /*int beaconcolor = (colorSensor.blue()) //get color here
            if(beaconcolor=	(0,0,255)){
